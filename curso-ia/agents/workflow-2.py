...
entrada_novo_evento = "Vamos agendar uma reunião de equipe na próxima terça-feira às 14h com Luiz e Felipe"
...
## novo teste
entrada_novo_evento = (
    "Você pode mover a reunião de equipe com Luiz e Felipe para quarta-feira às 15h?"
)
resultado = processar_solicitacao_calendario(entrada_novo_evento)
...
## novo teste 3
entrada_invalida = "Como está o clima hoje em São Paulo?"
